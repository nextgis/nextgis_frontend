import { getIcon, type IconOptions } from '@nextgis/icons';
import NgwMap from '@nextgis/ngw-leaflet';

import type { Feature, FeatureCollection, Point } from 'geojson';
const data: [IconOptions, [number, number]][] = [
...
NgwMap.create({
  ...
  const features: Feature<Point, IconOptions>[] = [];
  ...
  const geojson: FeatureCollection<Point, IconOptions> = {
    type: 'FeatureCollection',
    features: features,
  };

  function getPaint(feature: Feature<Point, IconOptions>) {
