    ...
    ***************************************************************************** */
        ...
        QmsKit.prototype.getQmsServices = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, loadJSON(this.url + '/api/v1/geoservices/')];
                });
            });
        };
        QmsKit.prototype._createAdapter = function (map) {
            var url = this.url;
            this.map = map;
            var alias = {
                tms: 'TILE',
            ...
            adapter.prototype.addLayer = function (options) {
                var _this = this;
                return loadJSON(url + '/api/v1/geoservices/' + options.qmsid).then(function (service) {
                    if (service) {
                        var type = alias[service.type];
                        var webMapAdapter = map.layerAdapters[type];
                        if (webMapAdapter) {
                            if (type === 'TILE') {
    ...
    function loadJSON(url) {
        return new Promise(function (resolve, reject) {
            ...
            xmlHttp.open('GET', fixUrlStr(url), true);
            xmlHttp.send(null);
        });
    }
