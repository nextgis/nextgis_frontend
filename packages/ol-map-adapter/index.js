(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ol/source/ImageWMS'), require('ol/layer/Image'), require('ol/source/OSM'), require('ol/layer/Tile'), require('ol/Map'), require('ol/proj'), require('ol/View')) :
    typeof define === 'function' && define.amd ? define(['exports', 'ol/source/ImageWMS', 'ol/layer/Image', 'ol/source/OSM', 'ol/layer/Tile', 'ol/Map', 'ol/proj', 'ol/View'], factory) :
    (factory((global.OlMapAdapter = {}),global.ImageWMS,global.ImageLayer,global.OSM,global.TileLayer,global.Map,global.proj,global.View));
}(this, (function (exports,ImageWMS,ImageLayer,OSM,TileLayer,Map,proj,View) { 'use strict';
    ...
    var OlMapAdapter = /** @class */ (function () {
        ...
        OlMapAdapter.prototype.addLayer = function (adapterDef, options) {
            ...
            if (adapterEngine) {
                ...
                this._layers[options.id] = { layer: layer, order: options.order || this._order++, onMap: false };
                this._length++;
