(function (global, factory) {
	...
	var apiConnector = createCommonjsModule(function (module, exports) {
	// region inline polyfills
	Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function (e, r) { if (null == e) throw new TypeError("Cannot convert first argument to object"); for (var t = Object(e), n = 1; n < arguments.length; n++) { var o = arguments[n]; if (null != o) for (var a = Object.keys(Object(o)), c = 0, b = a.length; c < b; c++) { var i = a[c], l = Object.getOwnPropertyDescriptor(o, i); void 0 !== l && l.enumerable && (t[i] = o[i]); } } return t } });
	...
	var NgwKit = /** @class */ (function () {
	    function NgwKit(options) {
	        ...
	        this.connector = new apiConnector({ baseUrl: this.url });
	    }
