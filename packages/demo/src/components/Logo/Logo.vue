    ...
    >
      ...
      <path
        ...
        d="M225.8,111.5V0.1l-81.9-0.1v20.8h59.6v23.8h-34v20.7h34v25.3H144
          v20.8L225.8,111.5"
      ></path>
      <path class="logo__item--dark" d="M502.3,0.1v20.8h-37.1v90.6h-22.3V20.9h-37.1V0.1L502.3,0.1"></path>
      <path
      ...
      ></path>
      <path class="logo__item--light" d="M674.9,111.5h22.2V0h-22.2V111.5z"></path>
      <path
        class="logo__item--light"
      ...
      ></path>
      <path class="logo__item--dark" d="M340.2,43.3l31.6-43.2h-26.2L327,25.4L340.2,43.3"></path>
      <path
        class="logo__item--light"
        d="M332.8,53.5L293.6,0.1h-26.2l39,53.4l-42.6,58h26.5L332.8,53.5"
      ></path>
      <path class="logo__item--dark" d="M340.2,63.6l-13.2,18l21.9,29.9h26.4L340.2,63.6"></path>
    </svg>
</template>
<script lang="ts">
