    ...
    ***************************************************************************** */
    ...
    var WebLayerEntry = /** @class */ (function (_super) {
        ...
        WebLayerEntry.prototype.initItem = function (item) {
            ...
            if (item.item_type === 'group' || item.item_type === 'root') {
                ...
                var url = fixUrlStr(this.options.ngwConfig.applicationUrl + '/api/component/render/image');
    ...
    var WebMap = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            settings = _a.sent();
                            if (settings) {
                                rootLayer = settings.webmap.root_item;
                                if (rootLayer) {
        ...
        WebMap.prototype._zoomToInitialExtent = function () {
            var _a = this.runtimeParams.getParams(), lat = _a.lat, lon = _a.lon, zoom = _a.zoom, angle = _a.angle;
            if (zoom && lon && lat) {
                this.map.setCenter([
                    parseFloat(lon),
                    parseFloat(lat),
                ...
                if (angle) {
                    this.map.setRotation(parseFloat(angle));
                }
            }
            else {
