...
export declare type AdapterConstructor = () => Promise<
...
export declare interface MainLayerAdapter<
  M = any,
  L = any,
...
export declare type CallbackFilter<F extends Feature = Feature, L = any> = (
  opt: LayerDefinition<F, L>
) => boolean;
export { checkIfPropertyFilter };

export declare type ControlPositions =
  | 'top-right'
  | 'top-left'
  | 'bottom-right'
  | 'bottom-left';
...
declare function createToggleControl<C = any>(
...
export declare type DataLayerFilter<
...
declare function detectGeometryType(
...
declare function findMostFrequentGeomType(
...
export declare interface GeoJsonAdapterOptions<
  F extends Feature = Feature,
  L = any
...
export declare type LayerAdapter<
  M = any,
  L = any,
  O extends AdapterOptions = AdapterOptions
...
export declare type LngLatBoundsArray =
...
export declare interface MvtAdapterOptions<F extends Feature = Feature>
...
declare function onLoad<E extends WebMapEvents = WebMapEvents>(
  event: keyof E
): (
  _target: WebMap<any, any, any, WebMapEvents>,
  _propertyKey: string,
...
declare abstract class StateItem<V extends any | undefined = any | undefined>
...
declare function updateGeoJsonAdapterOptions(
  opt: GeoJsonAdapterOptions
): GeoJsonAdapterOptions;

export declare type VectorAdapterLayerType =
  | 'fill'
  | 'circle'
  | 'line'
  | 'icon';

export declare interface VectorAdapterOptions<
  F extends Feature = Feature,
  L = any
...
export declare interface VectorLayerAdapter<
  M = any,
  L = any,
...
export declare class WebMapLayers<
  M = any,
  L = any,
  C = any,
  E extends WebMapEvents = WebMapEvents
> extends BaseWebMap<M, L, C, E> {
  ...
  getActiveBaseLayer():
    | import('./interfaces/LayerAdapter').MainLayerAdapter<
        any,
        any,
        AdapterOptions
      >
